...
import com.example.07TugasPBDindaLutfiah.R;
import com.example.07TugasPBDindaLutfiah.data.response.CustomerReviewsItem;
import com.example.07TugasPBDindaLutfiah.data.response.PostReviewResponse;
import com.example.07TugasPBDindaLutfiah.data.response.Restaurant;
import com.example.07TugasPBDindaLutfiah.data.response.RestaurantResponse;
import com.example.07TugasPBDindaLutfiah.data.retrofit.ApiConfig;
import com.example.07TugasPBDindaLutfiah.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String TAG = "com.example.ui.07TugasPBDindaLutfiah.MainActivity";
